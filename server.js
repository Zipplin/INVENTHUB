...
// Load local trusted certs generated by mkcert
const httpsOptions = {
...
// Plain HTTP server that only exists to redirect to HTTPS
    ...
    try {
        ...
        const response = await axios.post(
            "https://api.paystack.co/transaction/initialize",
            {
                ...
                amount: 100000,
                callback_url:
                    `https://localhost:${HTTPS_PORT}/pro/payment-success`
            },
            {
                headers: {
                    Authorization:
...
server.listen(HTTPS_PORT, () => {
    ...
    console.log(
        `🚀 InventHub running at https://localhost:${HTTPS_PORT}`
    );
